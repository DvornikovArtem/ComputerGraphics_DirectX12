...
namespace gfw
{
	...
	void DebugRenderSysImpl::InitPrimitives(Microsoft::WRL::ComPtr<ID3D12Device> device)
	{
		...
		ComPtr<ID3DBlob> vertexBlob = d3dUtil::CompileShader(L"../Shaders/Debug.hlsl", nullptr, "VSMain", "vs_4_0");
		ComPtr<ID3DBlob> pixelBlob  = d3dUtil::CompileShader(L"../Shaders/Debug.hlsl", nullptr, "PSMain", "ps_4_0");
